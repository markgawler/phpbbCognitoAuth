...
class simple_test extends \phpbb_database_test_case
{
	...
	public function test_column()
	{
		...
		$this->assertTrue($db_tools->sql_column_exists(USERS_TABLE, 'user_cogauth'), 'Asserting that column "user_cogauth" exists');
		$this->assertFalse($db_tools->sql_column_exists(USERS_TABLE, 'user_cogauth'), 'Asserting that column "user_cogauth" does not exist');
	}
}
